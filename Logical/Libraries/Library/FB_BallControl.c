...
void FB_BallControl(struct FB_BallControl* inst)
{
	...
	BallControl->STS.AutoActive = PaddleMotor->STS.AutoActive;
	BallControl->STS.Disabled = PaddleMotor->STS.Disabled;
	BallControl->STS.Initializing = PaddleMotor->STS.Initializing;
	BallControl->STS.Running = PaddleMotor->STS.Running;
	BallControl->STS.Interlocked = PaddleMotor->STS.Interlocked & inst->Shooter->STS.Interlocked;
}
