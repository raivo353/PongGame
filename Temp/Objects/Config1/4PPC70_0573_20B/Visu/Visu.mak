...
VCFIRMWARE=4.73.4
VCFIRMWAREPATH=$(AS_VC_PATH)/Firmware/V4.73.4/SG4
...
PANEL_HW_SOURCE_Visu=C:/projects/AutomatedPongGame/Physical/Config1/Hardware.hw 
DIS_OBJECTS_Visu=$(PANEL_HW_OBJECT_Visu) $(KEYMAP_OBJECTS_Visu)

# KeyMapping flags
KEYMAP_SOURCES_Visu=$(AS_PROJECT_PATH)/Physical/Config1/4PPC70_0573_20B/VC/4PPC70_0573_20B.dis 
KEYMAP_OBJECTS_Visu=

# All Source Objects
FNINFO_SOURCES_Visu=$(AS_PROJECT_PATH)/Logical/Visu/Fonts/DefaultFont.fninfo \
	$(AS_PROJECT_PATH)/Logical/Visu/Fonts/GroteLetters.fninfo \
	$(AS_PROJECT_PATH)/Logical/Visu/Fonts/MiddelgroteLetters.fninfo \
	$(AS_PROJECT_PATH)/Logical/Visu/Fonts/KleineLetters.fninfo 
...
BMINFO_SOURCES_Visu=$(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Bitmap_1.bminfo \
	...
	$(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Red_Arrow_Down.bminfo \
	$(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Red_Arrow_Left.bminfo \
	$(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Red_Arrow_Right.bminfo \
	$(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Red_Arrow_Up.bminfo \
	$(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/PongLogo.bminfo \
	$(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Red_Arrow_Down_Small.bminfo \
	$(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Red_Arrow_Left_Small.bminfo \
	$(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Red_Arrow_Right_Small.bminfo \
	$(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Red_Arrow_Up_Small.bminfo 

PAGE_SOURCES_Visu=$(AS_PROJECT_PATH)/Logical/Visu/Pages/StartPage.page \
	$(AS_PROJECT_PATH)/Logical/Visu/Pages/Instellingen.page \
	$(AS_PROJECT_PATH)/Logical/Visu/Pages/SensorData.page \
	$(AS_PROJECT_PATH)/Logical/Visu/Pages/ManualControl.page 

VCS_SOURCES_Visu=$(AS_PROJECT_PATH)/Logical/Visu/StyleSheets/Color.vcs 

BDR_SOURCES_Visu=$(AS_PROJECT_PATH)/Logical/Visu/Borders/rand.bdr \
	$(AS_PROJECT_PATH)/Logical/Visu/Borders/Double3D.bdr \
	$(AS_PROJECT_PATH)/Logical/Visu/Borders/dikkerand.bdr 
...
$(PANEL_HW_VCI_Visu): $(PANEL_HW_SOURCE_Visu) $(VC_LIBRARY_LIST_Visu) $(KEYMAP_SOURCES_Visu) $(PALFILE_Visu)
	$(VCHWPP) -f '$<' -o '$@' -n Visu -d Visu -pal '$(PALFILE_Visu)' -c '$(AS_CONFIGURATION)' -p '$(AS_PLC)' -ptemp '$(AS_TEMP_PLC)' -B 'R4.93' -L '' -verbose 'False' -profile 'False' -hw '$(CPUHWC)' -warninglevel 2 -so $(VC_STATIC_OPTIONS_Visu) -sos $(VC_STATIC_OPTIONS_Shared) -fp '$(AS_VC_PATH)/Firmware/V4.73.4/SG4' -sfas -prj '$(AS_PROJECT_PATH)' -apj 'AutomatedPongGame' -vcob '$(VCOBJECT_Visu)'

$(PANEL_HW_OBJECT_Visu): $(PANEL_HW_VCI_Visu) $(VC_LIBRARY_LIST_Visu)
	$(VCC) -f '$(subst .vco,.vci,$@)' -o '$@' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -k '$(VCVK_SOURCES_Visu)' $(VCCFLAGS_Visu) -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4734 -sfas


# Pages
PAGE_OBJECTS_Visu = $(addprefix $(TEMP_PATH_Visu)/page., $(notdir $(PAGE_SOURCES_Visu:.page=.vco)))

$(TEMP_PATH_Visu)/page.StartPage.vco: $(AS_PROJECT_PATH)/Logical/Visu/Pages/StartPage.page $(VC_LANGUAGES_Visu)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu) -P '$(AS_PROJECT_PATH)' -ds '$(SRC_PATH_Visu)/StyleSheets/Color.vcs' -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4734 -sfas


$(TEMP_PATH_Visu)/page.Instellingen.vco: $(AS_PROJECT_PATH)/Logical/Visu/Pages/Instellingen.page $(VC_LANGUAGES_Visu)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu) -P '$(AS_PROJECT_PATH)' -ds '$(SRC_PATH_Visu)/StyleSheets/Color.vcs' -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4734 -sfas


$(TEMP_PATH_Visu)/page.SensorData.vco: $(AS_PROJECT_PATH)/Logical/Visu/Pages/SensorData.page $(VC_LANGUAGES_Visu)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu) -P '$(AS_PROJECT_PATH)' -ds '$(SRC_PATH_Visu)/StyleSheets/Color.vcs' -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4734 -sfas


$(TEMP_PATH_Visu)/page.ManualControl.vco: $(AS_PROJECT_PATH)/Logical/Visu/Pages/ManualControl.page $(VC_LANGUAGES_Visu)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu) -P '$(AS_PROJECT_PATH)' -ds '$(SRC_PATH_Visu)/StyleSheets/Color.vcs' -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4734 -sfas
...
$(TEMP_PATH_Visu)/vcs.Color.vco: $(AS_PROJECT_PATH)/Logical/Visu/StyleSheets/Color.vcs
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu) -P '$(AS_PROJECT_PATH)' -ds $(DEFAULT_STYLE_SHEET_Visu) -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4734 -sfas
...
$(TEMP_PATH_Visu)/vcvk.VirtualKeys.vco: $(AS_PROJECT_PATH)/Logical/Visu/VirtualKeys.vcvk
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4734 -sfas
...
$(TEMP_PATH_Visu)/bminfo.Red_Arrow_Down.vco: $(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Red_Arrow_Down.bminfo $(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Red_Arrow_Down.png
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4734 -sfas


$(TEMP_PATH_Visu)/bminfo.Red_Arrow_Left.vco: $(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Red_Arrow_Left.bminfo $(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Red_Arrow_Left.png
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4734 -sfas


$(TEMP_PATH_Visu)/bminfo.Red_Arrow_Right.vco: $(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Red_Arrow_Right.bminfo $(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Red_Arrow_Right.png
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4734 -sfas


$(TEMP_PATH_Visu)/bminfo.Red_Arrow_Up.vco: $(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Red_Arrow_Up.bminfo $(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Red_Arrow_Up.png
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4734 -sfas


$(TEMP_PATH_Visu)/bminfo.PongLogo.vco: $(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/PongLogo.bminfo $(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/PongLogo.png
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4734 -sfas


$(TEMP_PATH_Visu)/bminfo.Red_Arrow_Down_Small.vco: $(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Red_Arrow_Down_Small.bminfo $(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Red_Arrow_Down_Small.png
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4734 -sfas


$(TEMP_PATH_Visu)/bminfo.Red_Arrow_Left_Small.vco: $(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Red_Arrow_Left_Small.bminfo $(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Red_Arrow_Left_Small.png
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4734 -sfas


$(TEMP_PATH_Visu)/bminfo.Red_Arrow_Right_Small.vco: $(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Red_Arrow_Right_Small.bminfo $(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Red_Arrow_Right_Small.png
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4734 -sfas


$(TEMP_PATH_Visu)/bminfo.Red_Arrow_Up_Small.vco: $(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Red_Arrow_Up_Small.bminfo $(AS_PROJECT_PATH)/Logical/Visu/Bitmaps/Red_Arrow_Up_Small.png
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4734 -sfas
...
# Borders
#
BDR_SOURCES_Visu=$(AS_PROJECT_PATH)/Logical/Visu/Borders/rand.bdr $(AS_PROJECT_PATH)/Logical/Visu/Borders/Double3D.bdr $(AS_PROJECT_PATH)/Logical/Visu/Borders/dikkerand.bdr 
...
$(VCR_OBJECT_Visu) : $(VCR_SOURCE_Visu)
	$(VCC) -f '$<' -o '$@' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -sl en $(VCCFLAGS_Visu) -rt  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4734 -sfas
...
$(TEMP_PATH_Visu)/Visu01.ccf: $(LIB_SHARED) $(SHARED_CCF) $(LIB_BMP_RES_Visu) $(TEMP_PATH_Visu)/Visu03.ccf $(LIB_LOCAL_RES_Visu) $(TEMP_PATH_Visu)/Visu02.ccf $(DIS_OBJECTS_Visu) $(PAGE_OBJECTS_Visu) $(VCS_OBJECTS_Visu) $(VCVK_OBJECTS_Visu) $(VCRT_OBJECTS_Visu) $(TPR_OBJECTS_Visu) $(TXTGRP_OBJECTS_Visu) $(LAYER_OBJECTS_Visu) $(VCR_OBJECT_Visu) $(TDC_OBJECTS_Visu) $(TRD_OBJECTS_Visu) $(TRE_OBJECTS_Visu) $(PRC_OBJECTS_Visu) $(SCR_OBJECTS_Visu)
	...
	$(LINK) '$@.lfl' -o '$@' -p Visu -lib '$(LIB_LOCAL_OBJ_Visu)' -P '$(AS_PROJECT_PATH)' -m 'local objects' -profile 'False' -warningLevel2 -vcr 4734 -sfas
# 01 Module END
...
$(TEMP_PATH_Visu)/Visu02.ccf: $(LIB_SHARED) $(SHARED_CCF) $(LIB_BMP_RES_Visu) $(TEMP_PATH_Visu)/Visu03.ccf $(BDR_OBJECTS_Visu) $(LFNT_OBJECTS_Visu) $(CLM_OBJECTS_Visu)
	...
	$(LINK) '$@.lfl' -o '$@' -p Visu -lib '$(LIB_LOCAL_RES_Visu)' -P '$(AS_PROJECT_PATH)' -m 'local resources' -profile 'False' -warningLevel2 -vcr 4734 -sfas
# 02 Module END
...
$(TEMP_PATH_Visu)/Visu03.ccf: $(LIB_SHARED) $(SHARED_CCF) $(BMGRP_OBJECTS_Visu) $(BMINFO_OBJECTS_Visu) $(PALFILE_Visu)
	...
	$(LINK) '$@.lfl' -o '$@' -p Visu -lib '$(LIB_BMP_RES_Visu)' -P '$(AS_PROJECT_PATH)' -m 'bitmap resources' -profile 'False' -warningLevel2 -vcr 4734 -sfas
# 03 Module END
...
vcPostBuild_Visu :
	$(VCC) -pb -vcm '$(TEMP_PATH_Visu)/MODULEFILES.vcm' -fw '$(VCFIRMWAREPATH)' $(VCCFLAGS_Visu) -p Visu -vcr 4734 -sfas
