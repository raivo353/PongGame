...
#ifndef _BUR_1774280074_7_
#define _BUR_1774280074_7_
...
_BUR_LOCAL unsigned char digitalOutputs;
_BUR_LOCAL unsigned short hmiActPosition;
...
_BUR_LOCAL plcbit decrementTrapperAccDecc;
_BUR_LOCAL plcbit incrementTrapperAccDecc;
_BUR_LOCAL plcbit turnOnSolenoid;
_BUR_LOCAL plcbit turnOnVentilator;
_BUR_LOCAL plcbit incrementTrapperSpeed;
_BUR_LOCAL plcbit decrementTrapperSpeed;
...
/* Used IEC files */
__asm__(".ascii \"iecfile \\\"Logical/gAxis01obj/gAxis01Basic/basic.var\\\" scope \\\"local\\\"\\n\"");
